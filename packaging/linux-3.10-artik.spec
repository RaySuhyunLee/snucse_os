%define config_name artik5_defconfig
%define buildarch arm
%define target_board artik5
%define variant %{buildarch}-%{target_board}
%define dtb_name exynos3250-artik5.dtb

Name: artik5-linux-kernel
Summary: The Linux Kernel for ARTIK5
Version: 3.10.93
Release: 0
License: GPL-2.0
ExclusiveArch: %{arm}
...
Group: System/Kernel
# Create more Provides-profile statements if this supports other profiles
Provides: %{variant}-artik5-kernel-profile-common = %{version}-%{release}
